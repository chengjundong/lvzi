...
<body>
	...
	<div class="container">
		<div>
			<h3>
				<a href="admin/uploadOriginTracePic" class="sgbtn">上传溯源图片</a> 上传资质图片
			</h3>
			<div style="text-align: left; margin-top: 20px;">
				<form method="post" id="theform" action="admin/uploadPic_uploadAuthenticationPic" enctype="multipart/form-data">
					<input type="hidden" name="type" value="zizhi" /> 
